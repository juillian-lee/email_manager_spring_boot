...
public class UserPrincipal implements UserDetails {
	private static final long serialVersionUID = 3098945059440562401L;
	...
	public static UserPrincipal create(Login user) {
		...
		return new UserPrincipal(user.getId(), user.getNome(), user.getEmail(), user.getEmail(), user.getPassword(),
				authorities);
	}
